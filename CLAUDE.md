...
- **Versión:** 1.4.0 (2026-07-17) publicada y en uso; lote de hoy (renombrado seguro, fix sync de alumnos, alumnos↔profesor, web con login de empresa+perfiles+prácticas por alumno+rediseño visual, fix de secuencias de ids en la nube; detalle en HISTORIAL.md) cerrado el 2026-07-18, aún SIN publicar como release. Los 2 PCs siguen en 1.4.0; web-remote ya desplegada y verificada en producción. Suite: 108 tests en verde (`npm test`).
