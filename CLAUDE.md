...
- **Versión:** 1.7.0 (2026-07-20) publicada en GitHub (https://github.com/danixp3/kmalumnos/releases/tag/v1.7.0) con auto-update verificado (latest.yml → 1.7.0, instalador HTTP 200); persistencia de tema (sin parpadeo claro/oscuro al abrir) y mejoras de tutorial, aplicadas por Víctor (primer colaborador externo, acceso de push verificado). Los PCs se actualizarán solos al reiniciar la app. Suite: 119 tests en verde (`npm test`).
