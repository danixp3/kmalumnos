...
- **Versión:** 1.4.0 (2026-07-17) publicada con auto-update verificado; web-remote desplegada y verificada. Sync bidireccional OK: nube = espejo del PC principal (3 vehículos / 16 alumnos / 132 prácticas). Suite: 38 tests en verde (`npm test`).
...
- **UX escritorio (2026-07-17):** sidebar reorganizado en 4 grupos (Gestión/Análisis/Datos/Sistema); páginas fusionadas con pestañas internas (Kilómetros: Mapa+Conflictos; Datos: Importar/Exportar/Comparar; Ajustes: fusiona Backup con sync, copia de seguridad, actualizaciones); footer del sidebar simplificado (sync compacto + versión vía nuevo IPC `app:version`) y nueva preferencia de rango km por defecto. Tests: 38 en verde (sin tests nuevos).
